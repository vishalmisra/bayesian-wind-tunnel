...
frame-specific damage is confined to the entry band. Routing substrate is not writer computation. Cross-architecture
experiments separate the principle from the implementation: an LSTM and
